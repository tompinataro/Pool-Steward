# Development & Testing Methods for Pool Steward
...
- Currently pointing to Heroku: `https://pool-steward-2a872c497756.herokuapp.com`
...
### Why Point to Heroku?
**Current setup:** All builds point to `https://pool-steward-2a872c497756.herokuapp.com`
...
1. **Update build number** in `mobile/ios/PoolSteward/Info.plist`
...
## Current Best Practice for Pool Steward
...
- **Native iOS:** `mobile/ios/PoolSteward/Info.plist` → `CFBundleVersion`
- **NOT in:** `app.json` (ignored in bare workflow)

### How to Increment
```bash
# Update to build 46
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 46" mobile/ios/PoolSteward/Info.plist

# Verify
/usr/libexec/PlistBuddy -c "Print :CFBundleVersion" mobile/ios/PoolSteward/Info.plist
```
