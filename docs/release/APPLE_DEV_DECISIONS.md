# Apple Developer Decisions — Pool Steward
...
- Description suggestion: "Pool Steward mobile app" (avoid punctuation/special characters to prevent "Invalid description" errors)
...
App Store Connect
- New App → iOS → Name: Pool Steward → Bundle ID: `com.tixpy.poolsteward` → SKU: `pool-steward-ios-1`
