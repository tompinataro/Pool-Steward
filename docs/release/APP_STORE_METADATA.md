# App Store Connect Metadata — Pool Steward (Draft v1.0)
...
- Age Rating: 4+
- Privacy Policy URL: https://tompinataro.github.io/Pool-Steward/privacy
- Support URL: https://tompinataro.github.io/Pool-Steward/support
- Marketing URL: https://tompinataro.github.io/Pool-Steward/

Description (Short Form)
Pool Steward helps field technicians complete daily pool maintenance routes quickly and accurately. View today’s route, check in/out with optional location, complete a simple checklist, and leave notes for the office. Works offline and syncs automatically when online.

Description (Long Form)
Pool Steward streamlines pool maintenance for field teams:
...
- API (staging): https://api.example.com
