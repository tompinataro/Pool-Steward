...
- Goal: Create the App ID, decide capabilities, and align App Store/Provisioning choices for Pool Steward.
...
- App ID (Bundle ID): `com.tixpy.poolsteward` (Explicit)
- App Name (ASC): Pool Steward
...
1) Register App ID
   - Platform: iOS
   - Description: Use a simple value (e.g., "Pool Steward mobile app").
     - Note: If you see “Invalid description.” remove punctuation (colon/quotes) and keep it short.
   - Bundle ID: Explicit → `com.tixpy.poolsteward`
...
2) (Optional) If you prefer manual signing (not recommended here)
   ...
   - Create App Store provisioning profile for `com.tixpy.poolsteward`
...
1) My Apps → New App
   ...
   - Bundle ID: `com.tixpy.poolsteward`
   - SKU: `pool-steward-ios-1`
...
- [ ] App Store Connect → My Apps → New App
  - [ ] Platform: iOS, Name: Pool Steward, Language: English (US)
  - [ ] Bundle ID: `com.tixpy.poolsteward`, SKU: `pool-steward-ios-1`, Access: Full
...
## Done When
- App ID exists and matches `com.tixpy.poolsteward`
